package com.javaguru.student_igors_jurkovs.lesson_3.level_x.solutions.super_task_1;
...
public class UserLoginServiceTest {
	...
	@CodeReviewComment(teacher = "нет необходимости прописывать весь путь до класса com.javaguru.teacher.lesson_3.homework.level_x.solutions.super_task_1...")
	...
	public void shouldSetAttemptsLeftTo3AfterSuccessfulLogin() {
		com.javaguru.teacher.lesson_3.homework.level_x.solutions.super_task_1.UserLoginService service = new UserLoginService();
		com.javaguru.teacher.lesson_3.homework.level_x.solutions.super_task_1.User user = new User("javaguru", "abcd");
		service.login(user, "incorrect password");
		service.login(user, "incorrect password");
